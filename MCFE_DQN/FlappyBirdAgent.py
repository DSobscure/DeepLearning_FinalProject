    ...
    for episode in range(1000000):
        ...
        for t in itertools.count():
            ...
            if len(replay_memory) > INIT_REPLAY_MEMORY_SIZE and total_t % 8 == 0:
                ...
                trained_reward_batch = drn.get_values(next_state_batch)

                dqn.update(sess, state_batch, action_batch, trained_reward_batch, done_batch, next_state_batch)          
                drn.update(sess, state_batch, reward_batch)     
            ...
            if done or t > 10000:     
                ...
                for episode_replay in episode_replay_memory:
                    ...
                    replay_memory.append((_state, _action, _reward, _done, _next_state));
